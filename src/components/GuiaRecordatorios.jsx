      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="md" fullWidth>
        ...
        <DialogContent dividers>
          <Typography component="div" gutterBottom>
            <div className="guia-text space-y-3 text-sm">
              <p>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="guia-card rounded-lg border p-3">
                  <p className="font-bold mb-1">Anticipación (evento)</p>
                  <p>
                ...
                <div className="guia-card rounded-lg border p-3">
                  <p className="font-bold mb-1">Canal</p>
                  <p>
                    Puedes enviar por WhatsApp, por correo o por ambos canales.
                  </p>
                </div>
                <div className="guia-card rounded-lg border p-3">
                  <p className="font-bold mb-1">Recordatorio libre</p>
                  <p>
                ...
                <div className="guia-card rounded-lg border p-3">
                  <p className="font-bold mb-1">Ventana de envío</p>
                  <p>
                ...
                <div className="guia-card rounded-lg border p-3 sm:col-span-2">
                  <p className="font-bold mb-1">Límites para evitar spam</p>
                  <p>
              ...
              <div className="guia-card guia-card-soft rounded-lg border p-3">
