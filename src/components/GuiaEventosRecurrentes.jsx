            ...
            <div className="guia-text space-y-3 text-sm">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="guia-card rounded-lg border p-3">
                  <p className="font-bold mb-1">Diario</p>
                  <p>
                ...
                <div className="guia-card rounded-lg border p-3">
                  <p className="font-bold mb-1">Semanal</p>
                  <p>
                ...
                <div className="guia-card rounded-lg border p-3 sm:col-span-2">
                  <p className="font-bold mb-1">Personalizado</p>
                  <p>
                ...
                <div className="guia-card rounded-lg border p-3 sm:col-span-2">
                  <p className="font-bold mb-1">Paso a paso</p>
                  <p>
